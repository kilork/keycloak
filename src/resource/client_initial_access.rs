...
impl<'a, TS: KeycloakTokenSupplier> KeycloakRealmAdmin<'a, TS> {
    ...
    ///
    /// Documentation: <https://www.keycloak.org/docs-api/26.7.3/rest-api/index.html#_get_adminrealmsrealmclients_initial_access>
    ...
    ///
    /// Documentation: <https://www.keycloak.org/docs-api/26.7.3/rest-api/index.html#_post_adminrealmsrealmclients_initial_access>
    ...
    ///
    /// Documentation: <https://www.keycloak.org/docs-api/26.7.3/rest-api/index.html#_delete_adminrealmsrealmclients_initial_accessid>
