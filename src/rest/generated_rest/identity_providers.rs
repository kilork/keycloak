...
impl<TS: KeycloakTokenSupplier> KeycloakAdmin<TS> {
    ...
    ///
    /// Documentation: <https://www.keycloak.org/docs-api/26.7.3/rest-api/index.html#_post_adminrealmsrealmidentity_providerimport_config>
    ...
    ///
    /// Documentation: <https://www.keycloak.org/docs-api/26.7.3/rest-api/index.html#_get_adminrealmsrealmidentity_providerinstances>
    ...
    pub async fn realm_identity_provider_instances_get(
        ...
        if let Some(v) = capability {
            builder = builder.query(&[("capability", v)]);
        }
        if let Some(v) = first {
    ...
    ///
    /// Documentation: <https://www.keycloak.org/docs-api/26.7.3/rest-api/index.html#_post_adminrealmsrealmidentity_providerinstances>
    ...
    ///
    /// Documentation: <https://www.keycloak.org/docs-api/26.7.3/rest-api/index.html#_get_adminrealmsrealmidentity_providerinstancesalias>
    ...
    ///
    /// Documentation: <https://www.keycloak.org/docs-api/26.7.3/rest-api/index.html#_put_adminrealmsrealmidentity_providerinstancesalias>
    ...
    ///
    /// Documentation: <https://www.keycloak.org/docs-api/26.7.3/rest-api/index.html#_delete_adminrealmsrealmidentity_providerinstancesalias>
    ...
    ///
    /// Documentation: <https://www.keycloak.org/docs-api/26.7.3/rest-api/index.html#_get_adminrealmsrealmidentity_providerinstancesaliasexport>
    ...
    ///
    /// Documentation: <https://www.keycloak.org/docs-api/26.7.3/rest-api/index.html#_get_adminrealmsrealmidentity_providerinstancesaliasmanagementpermissions>
    ...
    ///
    /// Documentation: <https://www.keycloak.org/docs-api/26.7.3/rest-api/index.html#_put_adminrealmsrealmidentity_providerinstancesaliasmanagementpermissions>
    ...
    ///
    /// Documentation: <https://www.keycloak.org/docs-api/26.7.3/rest-api/index.html#_get_adminrealmsrealmidentity_providerinstancesaliasmapper_types>
    ...
    ///
    /// Documentation: <https://www.keycloak.org/docs-api/26.7.3/rest-api/index.html#_get_adminrealmsrealmidentity_providerinstancesaliasmappers>
    ...
    ///
    /// Documentation: <https://www.keycloak.org/docs-api/26.7.3/rest-api/index.html#_post_adminrealmsrealmidentity_providerinstancesaliasmappers>
    ...
    ///
    /// Documentation: <https://www.keycloak.org/docs-api/26.7.3/rest-api/index.html#_get_adminrealmsrealmidentity_providerinstancesaliasmappersid>
    ...
    ///
    /// Documentation: <https://www.keycloak.org/docs-api/26.7.3/rest-api/index.html#_put_adminrealmsrealmidentity_providerinstancesaliasmappersid>
    ...
    ///
    /// Documentation: <https://www.keycloak.org/docs-api/26.7.3/rest-api/index.html#_delete_adminrealmsrealmidentity_providerinstancesaliasmappersid>
    ...
    ///
    /// Documentation: <https://www.keycloak.org/docs-api/26.7.3/rest-api/index.html#_get_adminrealmsrealmidentity_providerinstancesaliasreload_keys>
    ...
    ///
    /// Documentation: <https://www.keycloak.org/docs-api/26.7.3/rest-api/index.html#_get_adminrealmsrealmidentity_providerprovidersprovider_id>
