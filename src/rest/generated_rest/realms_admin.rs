...
impl<TS: KeycloakTokenSupplier> KeycloakAdmin<TS> {
    ...
    /// `GET /admin/realms`
    ///
    /// Documentation: <https://www.keycloak.org/docs-api/26.5.2/rest-api/index.html#_get_adminrealms>
    pub async fn get(
        &self,
    ...
    /// `POST /admin/realms`
    ///
    /// Documentation: <https://www.keycloak.org/docs-api/26.5.2/rest-api/index.html#_post_adminrealms>
